...
<!-- TOP BANNER -->
<!--a href="http://www.bestrussiantv.com" target="_new"><img src="http://www.torontovka.com/absolutebm/banners/Torontovka/bestrussiantv_468x60.gif" border="0"></a><br-->
<a href="http://www.bestrussiantv.com" target="_new"><img src="http://www.torontovka.com/absolutebm/banners/Torontovka/bestrussiantv_468x60.gif" border="0"></a><br>
<p>
...
%>
<!--Reklama -->
<table cellpadding="0" cellspacing="0" border="0" style="margin-top: 0px;"><tr><td><img src="http://www.torontovka.com/images/sheaders/ads_ru.gif" height="20" alt="Polling at Torontovka"></td></tr></table>

	<table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom: 4px; border: solid 2px #c1c1c1" bgcolor="#f7e2e1">
	<tr>
		<td align="left" class="clsDefaultText" style="padding: 4px">
				<b>Нашим клиентам банки не отказывают</b>
				<br>
				<img src="http://www.torontovka.com/images/ads/morozovi.jpg" alt="Oksana & Zhanna Morozova">
				<br>
				<b>Жанна и Оксана Морозовы.</b> 
				<br>
				Все виды Ипотеки. У нас всегда есть деньги для Вас.
				<br>
				<b>Их рекомендуют друзьям.</b>
				<br>
				(905) 764-6000
				<br>
				(416) 465-6165
...
<!--Reklama End -->	
<!--a href="http://www.torontovka.com/misc/video_news_ntv.asp" target="_new"><img src="http://www.torontovka.com/images/ntv_news.gif" border="0" alt="Видео Обзор Канадских Новостей За Неделю - HTB Canada" style="cursor:hand"></a-->
<!-- MaxRiga TV Start -->
	<p>
...
<%
	dim videos
	set videos = New List
	videos.add( CreateVideoObject( "/enter/video/images/zhasmin.jpg", "mms://38.99.140.151/rtd/zhasmin.wmv", "Zhasmin", "", "" ) )
	videos.add( CreateVideoObject( "/enter/video/images/kamburova.jpg", "mms://38.99.140.151/rtd/kamburova.wmv", "Elena Kamburova", "", "" ) )
	videos.add( CreateVideoObject( "/enter/video/images/bashmet.jpg", "mms://38.99.140.151/rtd/bashmet.wmv", "Yuri Bashmet", "", "" ) )
	videos.add( CreateVideoObject( "/enter/video/images/mumik09.jpg", "mms://38.99.140.151/rtd/mumik09.wmv", "Mumiy Troll - 2009", "", "" ) )
	videos.add( CreateVideoObject( "/enter/video/images/shvedova_skazka.jpg", "mms://38.99.140.151/rtd/shvedova_skazka.wmv", "Театр Ольги Шведовой - Сказка для взрослых", "", "" ) )
	videos.add( CreateVideoObject( "/enter/video/images/mixoels.jpg", "mms://38.99.140.151/rtd/mixoels.wmv", "Марк Розовский - Поющий Михоэлс", "", "" ) )
		%>
...
<br>
	...
	<!-- ANNONCEMENTS -->
		...
		<tr>
			...
			<a href="http://www.bestrussiantv.com" target="_blank">BestRussianTV.com - 2 дня бесплатного просмотра 60 русских и украинских каналов. Скрась выходные.</a>
	...
	<!-- ANNONCEMENTS -->
		<table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-top: 8px; border: solid 2px #c1c1c1">
		<tr>
			<td style="padding: 0px 4px 4px 4px; background-color: #<%= hexBackgroundColor %>;">
			
				<table cellpadding="0" cellspacing="0" border="0" style="margin-top: 4px;">
				<tr>
					<td valign="top"><img src="http://www.torontovka.com/images/li.gif" style="margin: 1px 4px 0px 2px;"></td>
					<td class="clsDefaultText"><a href="http://www.torontovka.com/default.asp?key=enter.video.misc">Видео с концертов Жасмин, Елены Камбуровой и Юрия Башмета.</a></td>
				</tr>
			</table>
            <table cellpadding="0" cellspacing="0" border="0" style="margin-top: 4px;">
				<tr>
					<td valign="top"><img src="http://www.torontovka.com/images/li.gif" style="margin: 1px 4px 0px 2px;"></td>
					<td class="clsDefaultText"><a href="http://www.torontovka.com/default.asp?key=enter.video.misc">Фрагменты выступлений из Театра У Никитских Ворот "Поющий Михоэлс" и Театра Ольги Шведовой "Сказка для взрослых"</a></td>
				</tr>
			</table>
			...
			<table cellpadding="0" cellspacing="0" border="0" style="margin-top: 4px;">
				<tr>
					<td valign="top"><img src="http://www.torontovka.com/images/li.gif" style="margin: 1px 4px 0px 2px;"></td>
					<td class="clsDefaultText"><a href="http://www.torontovka.com/default.asp?key=enter.video.misc">Видеофрагменты из концерта Владимира Спивакова и команды КВН "Федор Двинятин".</a></td>
				</tr>
			</table>
	...
	<tr>
		<td align="left" class="clsDefaultText" style="padding: 4px">
			<a href="http://www.yyztravel.com/BE-Last-Minute.aspx" target="_blank">Get Galaxy Away from Routine - Last Minute Online Trip Bookings with YYZ Travel<br><img src="http://www.torontovka.com/images/ads/yyztravel.jpg" alt="YYZ Travel" border="0"></a>
            <hr>
			<b>Весна в Алгонкин Парке!</b>
            <br>
Свежий воздух и отменное здоровье деньгами не купишь. Встречайте весну в Артексе.<br>
- Большой коттедж - 6 спален<br>
- Два малых коттеджа - 7 спален<p>
 <a href="http://www.artexclub.com" target="_blank">www.artexclub.com</a>
...
<%
Dim missId : missId = 3023
Dim misterId : misterId = 3021
...
%>
	...
	<!-- / MISS AND MISTER TORONTOVKA -->
	<!--br>
	<center><a href="http://www.bestrussiantv.com" target="_blank"><img src="http://www.torontovka.com/absolutebm/banners/Torontovka/bestrussiantv_120x600.gif" border="0"></a></center-->
	</td>
</tr>
</table>
